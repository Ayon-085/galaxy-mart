...
const {admin_checkOut, proceed, addShipment, getOrdersNotProcessed, getUsers, getAccount, getShipment, getOrdersBySupplier} = require('../controller/admin_supp_controller');
...
router.get('/users/orders', auth, getOrdersNotProcessed);
